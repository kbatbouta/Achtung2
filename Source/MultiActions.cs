...
namespace AchtungMod
{
    public class MultiActions
    {
        ...
        private T AllEqual<T, S>(IEnumerable<FloatMenuOption> options, Func<FloatMenuOption, S> compareFunc,
            Func<FloatMenuOption, T> valueFunc, T defaultValue) where T : class where S : class
        {
        ...
        private static float AllEqualFloat(IEnumerable<FloatMenuOption> options, Func<FloatMenuOption, float> eval,
            float defaultValue)
        {
            if (options.Count() == 0) return defaultValue;
        ...
        public FloatMenuOption GetOption(string title, IEnumerable<MultiAction> multiActions)
        {
            ...
            var mouseoverGuiAction =
                AllEqual(options, o => o.mouseoverGuiAction?.Method, o => o.mouseoverGuiAction, null);
            var revalidateClickTarget =
                AllEqual(options, o => o.revalidateClickTarget, o => o.revalidateClickTarget, null);
            ...
            var revalidateWorldClickTarget = AllEqual(options, o => o.revalidateWorldClickTarget,
                o => o.revalidateWorldClickTarget, null);
            ...
            var option = new FloatMenuOption(title, delegate
                ...
                }, priority, mouseoverGuiAction, revalidateClickTarget, extraPartWidth, extraPartOnGUI,
            ...
            if (extraPartOnGUI != null && forcedOptions.Count > 0)
            {
                ...
                option.extraPartOnGUI = drawRect =>
                    ((ForcedMultiFloatMenuOption) option).RenderExtraPartOnGui(drawRect);
            }
