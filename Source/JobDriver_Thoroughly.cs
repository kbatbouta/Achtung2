    ...
    public abstract class JobDriver_Thoroughly : JobDriver
    {
        ...
        public void CheckJobCancelling()
        {
            ...
            if (Tools.PawnOverHealthLevel(pawn))
            {
                ...
                Find.LetterStack.ReceiveLetter(LetterMaker.MakeLetter("JobInterruptedLabel".Translate(jobName),
                    "JobInterruptedBadHealth".Translate(pawn.Name.ToStringShort), LetterDefOf.NegativeEvent, pawn));
                return;
            }
        }
